...
let canUseJsbridgeInterface = true
      ...
      return new Promise((resolve, reject) => {
        if (!is('Object', command)) {
          ...
          try {
            ...
            // 如：[INFO:CONSOLE(90)] "Uncaught Error: Java exception was raised during method invocation", source: file:///android_asset/static_use_plugin_test.html (90)
            switch (e.message) {
